...
.option("j", {alias: "jwt", describe: "Will start a JWT token generation. You will need to Specify the Private Key value, as well as a valid json string for this to work (lookup -pk and -json for additional information", type: "string", demandOption: false, requiresArg: true})
